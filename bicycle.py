...
ax.set_title("Travel distances (bicycle)", fontsize=title_size)

highlight_x = [308]     # Legacy x-values
highlight_y = [60]   # OSRM y-values
...
plt.savefig("scatter_bicycle.svg", format="svg", bbox_inches='tight', pad_inches=0, dpi=96)  # Save as SVG
